...
( function( api ) {
	...
	// Extends our custom "Shopire" section.
	api.sectionConstructor['Shopire'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-shopire_sidebar_options select:not(#_customize-input-shopire_default_pg_sidebar_option), #sub-accordion-section-shopire_typography_options select, #sub-accordion-section-shopire_headings_typography select").prop('disabled', true);
});
