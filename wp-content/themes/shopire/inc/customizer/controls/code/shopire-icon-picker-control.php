...
class Shopire_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Shopire_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'shopire-icon-picker-css', SHOPIRE_THEME_INC_URI . '/customizer/controls/js/fonticonpicker/jquery.fonticonpicker.css', false );
			 
		wp_enqueue_script( 'shopire-icon-picker-js', SHOPIRE_THEME_INC_URI . '/customizer/controls/js/fonticonpicker/jquery.fonticonpicker.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
