(function ($) {
    ...
    wp.shopirecustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                shopire_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.shopirecustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.shopirecustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.shopirecustomizerRepeater.iconPickerToggle($(this));
        });
