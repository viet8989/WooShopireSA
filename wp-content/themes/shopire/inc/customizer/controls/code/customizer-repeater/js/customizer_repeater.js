...
jQuery(document).ready(function () {
    ...
    shopire_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-shopire_information_option')
		{	
			var totalItems = jQuery("#customize-control-shopire_information_option .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 4){
			  jQuery( "#customize-control-shopire_information_option_upsale .fable-extra-upgrade-message" ).show();
			  return false;   
			}
		}
    ...
    shopire_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var shopire_information_option = jQuery("#customize-control-shopire_information_option .customizer-repeater-general-control-repeater-container").length 
				if(shopire_information_option < 4){ 
				  jQuery( "#customize-control-shopire_information_option_upsale .fable-extra-upgrade-message" ).hide();
				}
				...
				if(shopire_slider_data_option < 3){ 
