 ...
 */
function shopire_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function shopire_sanitize_html( $html ) {
 ...
 */
function shopire_sanitize_select( $input, $setting ) {
 ...
 */
function shopire_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function shopire_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function shopire_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}